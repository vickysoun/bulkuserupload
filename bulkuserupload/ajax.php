...
/**
 * Ajax file of local_bulkuserupload.
 *
...
$cirid = optional_param('cir_id', null, PARAM_INT);

if ($cirid) {

    // Pass csv import reader id to re-initialize CIR.
    $uploaded = upload_csv_data($cirid);
